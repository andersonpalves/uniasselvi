    ...
    private void editar() {
        ...
        if (linha >= 0) {
            try {
                ...
                c.setNome(tabela.getModel().getValueAt(linha, 1).toString());
                c.setEmail(tabela.getModel().getValueAt(linha, 2).toString());
                c.setTelefone(tabela.getModel().getValueAt(linha, 3).toString());
                c.setCidade(tabela.getModel().getValueAt(linha, 4).toString());
                c.setEstado(tabela.getModel().getValueAt(linha, 5).toString());
                dao.atualizar(c);
                limparCampos();
                carregarTabela();
            } catch (SQLException ex) {
