...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $apiBase . '/criar');
        ...
        if ($httpCode === 201 || $httpCode === 200) {
            header('Location: index.php?status=success&msg=' . urlencode('Cliente criado com sucesso.'));
            exit;
        } else {
            $errors[] = "Erro ao criar cliente. Código: $httpCode";
        }
    }
}
?>
  ...
  <form method="post" id="formCliente" novalidate>
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        ...
        <input name="estado" class="form-control" id="estado" maxlength="2">
      </div>
    </div>
